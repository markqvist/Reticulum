...
To use the `BackboneInterface` over [Yggdrasil](https://yggdrasil-network.github.io/), you
...
To connect to remotes over [Yggdrasil](https://yggdrasil-network.github.io/), simply
...
To use the TCP Server Interface over [Yggdrasil](https://yggdrasil-network.github.io/), you
can simply specify the Yggdrasil `tun` device and a listening port, like so:
...
To use the TCP Client Interface over [Yggdrasil](https://yggdrasil-network.github.io/), simply
specify the target Yggdrasil IPv6 address and port, like so:
...
[Auto Interface](#interfaces-auto) performs *much* better, and is even
easier to use.
...
[Invisible Internet Protocol](https://i2pd.website). This can be
...
install the [latest release](https://github.com/PurpleI2P/i2pd/releases/latest)
of the `i2pd` package. For more details about I2P, see the
[geti2p.net website](https://geti2p.net/en/about/intro).
